...
Survival · Consistency · Discipline — a local-first Streamlit trade journal built around a three-pillar (Psychology/Risk/System) framework, with read-only MetaTrader 5 import paths for local and hosted use.
