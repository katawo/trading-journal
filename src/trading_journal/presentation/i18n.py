...
VI: dict[str, str] = {
    ...
    "Reset requested. Trading Journal will restart with a clean local database.": "Đã yêu cầu đặt lại. Trading Journal sẽ khởi động lại với cơ sở dữ liệu cục bộ mới.",
    "Restarting Trading Journal. This page will reload automatically when the clean journal is ready.": "Đang khởi động lại Trading Journal. Trang này sẽ tự tải lại khi nhật ký mới sẵn sàng.",
