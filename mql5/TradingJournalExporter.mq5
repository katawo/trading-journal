...
input string InpExportName = "trading_journal\\positions.csv";
...
void OnStart()
  {
   ...
   string temporary_name=InpExportName+".tmp";
   ...
   if(!FileMove(temporary_name,FILE_COMMON,InpExportName,FILE_COMMON|FILE_REWRITE))
     {
